...
#let int   = abbreviation("int",   "interrogative")
...
#let nmlz  = abbreviation("nmlz",  "nominalizer")
...
#let prox  = abbreviation("prox",  "proximate")
...
#let q     = abbreviation("q",     "question particle")
